    ...
    <div className= " bg-[#000000d2] absolute w-[100%] h-[100%] top-0 flex z-40 font-semibold">
      <div className="box4 bg-[#120c25cb] relative w-[80%] h-[60%] lg:h-[50%] md:mt-[150px] lg:mt-[150px] xl:w-[50%] xl:h-[60%] m-auto flex   justify-center ">
        <div className="text-[40px] text-white font-mono font-[600] w-[70%]">
          ...
          <div className={` text-[70px] md:text-[100px] lg:text-[120px] mt-[30px] ${cruurentwin=="X" ?'textX': 'textO'} `}> {cruurentwin}</div> 
          <div className="text-center text-[30px] md:text-[50px] md:p-[20px] xl:text-[70px]"> {textwin}</div> 
